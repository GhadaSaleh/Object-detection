...
get_ipython().run_cell_magic('bash', '', 'mkdir /tmp/checkpoint\nmkdir source_dir/checkpoint\nwget -O /tmp/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8.tar.gz http://download.tensorflow.org/models/object_detection/tf2/20200711/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8.tar.gz\ntar -zxvf /tmp/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8.tar.gz --strip-components 2 --directory source_dir/checkpoint ssd_resnet50_v1_fpn_640x640_coco17_tpu-8/checkpoint\n')
